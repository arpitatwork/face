    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                connection.commit()
                csv_name='C:/Python36/Attendace_system_major_project/Attendance'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:/Python36/Attendace_system_major_project/Attendance/Manually Attendance/-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='snow')
                cs = 'C:/Python36/Attendace_system_major_project/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:/Python36/Attendace_system_major_project/Attendance/-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'Ritu Kandari' :
            if password == 'igdtuw':
                ...
                cs = 'C:/Python36/Attendace_system_major_project/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
